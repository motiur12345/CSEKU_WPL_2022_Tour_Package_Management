<?php
    ...
    if(isset($_GET['delete'])){
        ...
        header('Location: agency-package.php');
        return;
    }
?>
...
<!--      here &nbsp;&nbsp is used to prevent automatic line break-->
            <div class="suggest-pack col "><a href="agency-create-pack2.php" ><h4><i class="fas fa-box k"></i> &nbsp;&nbsp; Create package</h4></a></div>
      <div class="suggest-pack col active"><a href="agency-package.php"><i class="fas fa-wallet k"></i>&nbsp;&nbsp; Packages</a></div>
    <div class="suggest-pack col "><a href="agency-payment.php" ><h4><i class="fas fa-box k"></i> &nbsp;&nbsp; Payments</h4></a></div>
<!--    <div class="suggest-pack col"><a href="agency-edit-tourscheme.html"><i class="fas fa-edit k"></i>  &nbsp;&nbsp;Edit Tour-scheme</a></div>-->
...
//                }else{
                    echo "<tr>";
                        ...
                        echo "<td><a href='agency-package.php?delete=". $package['package_id'] ."' class='btn btn-danger mt-1'><i class='fas fa-trash-alt'></i></a></td>";
